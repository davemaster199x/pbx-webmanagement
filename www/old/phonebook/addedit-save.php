...
<?php
	...
	$save_phonebook->param( 'api_token',    $jsonrpc['api_token'] );
	$save_phonebook->param( 'hash',         $_SESSION['user']['hash'] );
	$save_phonebook->param( 'client_id',    ( isset( $_POST['client_id'] ) ? $_POST['client_id'] : '' ));
	...
	if ( $result[ $save_phonebook->id ]['response'] != 'complete' ) {
