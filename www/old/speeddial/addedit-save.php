...
<?php
	...
	$save_speeddial = new jsonrpc\method( 'speeddial.save' );
	$save_speeddial->param( 'api_token',    $jsonrpc['api_token'] );
	$save_speeddial->param( 'hash',         $_SESSION['user']['hash'] );
	$save_speeddial->param( 'client_id',    ( isset( $_POST['client_id'] ) ? $_POST['client_id'] : '' ));
	$save_speeddial->param( 'speeddial_id', $_POST['speeddial_id'] );
	$save_speeddial->param( 'shortcut',     $_POST['shortcut'] );
	$save_speeddial->param( 'dest',         $_POST['dest'] );
